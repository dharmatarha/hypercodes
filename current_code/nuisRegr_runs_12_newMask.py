...
# -*- coding: utf-8 -*-
"""
Script to perform nuisance regression and timeseries extraction on storytelling
task (runs 1 & 2) data.

USAGE: python3 nuisRegr_runs_12_2021.py [--outFolder] [--confoundsFolder] [--mask] folder

The script first lists all functional nii.gz files and truncated confounds files
for hyperscanning runs 1 and 2. Then it applies
...
Modified again for runs 1,2 by JDK, July 2021
Modified again for new mask by JDK, Sept 2021
"""
...
def main():
    ...
    parser.add_argument(
        '-o',
        '--outFolder',
        default='/dartfs-hpc/rc/lab/W/WheatleyT/f00589z/hyperscanning/storytelling/nuisRegr_output_files',
        type=str,
    ...
    parser.add_argument(
        '-c',
        '--confoundsFolder',
        default='/dartfs-hpc/rc/lab/W/WheatleyT/f00589z/hyperscanning/storytelling/nuisRegr_input_files',
        type=str,
    ...
    parser.add_argument(
        ...
        nargs='?',
        type=str,
        default='/dartfs-hpc/rc/lab/W/WheatleyT/f00589z/hyperscanning/misc/mni_icbm152_nlin_asym_09c/mni_icbm152_t1_tal_nlin_asym_09c_mask_RESAMPLED.nii',
        help='Path to brainmask. This mask will be used for the '
             'NiftiMasker object. Default is mni_icbm152_t1_tal_nlin_asym_09c_mask_RESAMPLED.')
    ...
    if args.mask == 'nilearnMNI':  # if nilearn MNI mask is used
        ...
        try:
            maskImg = nImage.load_img(args.mask)
