...
for file = 1:4
    ...
    % file path
    filename = ['/home/adamb/Documents/hyperscanning_DBIC/sub-sid000',sid,'_task-storytelling',num2str(file),'_run-0',num2str(file),'_bold_confounds.tsv'];
    ...
    %% Save results
    save(['subject',sid,'_',num2str(file),'.mat']);
