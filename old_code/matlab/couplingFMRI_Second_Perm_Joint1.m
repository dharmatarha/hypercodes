function couplingFMRI_Second_Perm_Joint1
...
% !!! For DRZEUSS !!!
%
% Goes through DBIC participants 1-4 (2:5), pairs them up with all
...
% save file location
savePath = '/flash/wheatley/adamb/matlab/permSecond/permSecond_Joint_1.mat';
...
for dbicPairN = dbicSubjects
    ...
    dbicRun = runLookup2.joint(dbicPairN,2);
    ...
    for cbsPairN = cbsSubjects
        ...
        if ~isequal(dbicPairN, cbsPairN)
            ...
            % get runN
            cbsRun = runLookup2.joint(cbsPairN,2);
