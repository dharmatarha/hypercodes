function logPath = getLogPath_Second_v2(pairN, runN)
...
runName{1} = dir(['/media/adamb/TOSHIBA_EXT/hyperscanning_data_backup/Harvard_DBIC/',...
    'pair', num2str(pairN), '/DBIC/behav/run', num2str(runN),'*']);
logPath.dbic = ['/media/adamb/TOSHIBA_EXT/hyperscanning_data_backup/Harvard_DBIC/',...
    'pair', num2str(pairN), '/DBIC/behav/', runName{1}.name, '/'];

% get DHMC path to logs
runName{2} = dir(['/media/adamb/TOSHIBA_EXT/hyperscanning_data_backup/Harvard_DBIC/',...
    'pair', num2str(pairN), '/CBS/behav/run', num2str(runN),'*']);
logPath.cbs = ['/media/adamb/TOSHIBA_EXT/hyperscanning_data_backup/Harvard_DBIC/',...
