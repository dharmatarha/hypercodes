function couplingFMRI_First_Perm_Joint2
...
% save file location
savePath = '/flash/wheatley/adamb/matlab/permFirst/permFirst_Joint_2.mat';
...
for dbicPairN = dbicSubjects
    ...
    dbicRun = runLookup.joint(dbicPairN,2);
    ...
    for dhmcPairN = dhmcSubjects
        ...
        if ~isequal(dbicPairN, dhmcPairN)
            ...
            % get runN
            dhmcRun = runLookup.joint(dhmcPairN,2);
