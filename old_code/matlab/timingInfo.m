...
%
% Notes:
% - audio buffer length is assumed to be 0.256 sec
% - only run 1-2
...
disp([char(10), 'Started timingInfo script with inputs ', num2str(pairN),...
...
[packetStats, ~] = timestampsAnalyze(pairN, runN);
...
[ttls, speechTurnStamps, retellStartStamp] = timeline(pairN, runN);
