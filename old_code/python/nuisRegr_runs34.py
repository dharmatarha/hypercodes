...
USAGE: python3 nuisRegr_runs34.py [--mask] folder
...
the supplied confounds file. Standardization, spatial
smoothing and high-pass filtering are performed if specified
so in the magic numbers section.
Current default is high-pass filtering (cutoff at 0.01 Hz)
and spatial smoothing (4 mm fwhm).
...
def params():
    ...
    masker_fwhm = 4  # spatial smoothing
    masker_stand = False  # standardization
